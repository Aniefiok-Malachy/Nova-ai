      ...
      <div className="flex flex-col md:flex-row w-full flex-1 relative z-10">
        ...
        <div className="flex-none md:flex-1 p-8 pt-12 pb-4 md:p-16 md:pt-16 md:pb-16 relative z-10 flex flex-col justify-center items-center text-center md:items-start md:text-left">
          ...
          >
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-600">Future</span>
          </motion.h1>
          ...
          >
            Empower your workflow with Nova Ai's suite of intelligent tools. From predictive analytics to automated content generation, we build the engine for your success.
          </motion.p>
